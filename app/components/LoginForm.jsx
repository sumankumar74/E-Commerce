...
const LoginForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        let data = await fetch("http://localhost:3000/api/admin/login", {
    ...
    return (
        <div>
            <form onSubmit={handleSubmit}method="POST">
                ...
                <div className="flex  bg-red-500 py-2 rounded-md item-center justify-center border border-red-600 mb-4">
                    <button type="submit"  className="text-white text-2xl font-serif">Login</button>
                </div>
                <div className="signup flex bg-gradient-to-r from-black via-teal-500 to-black p-2  rounded-lg justify-center text-white ">
                    <Link href="/Register" >Sign Up / Register</Link>
                </div>
            </form></div>
    )
}
